...
void TeenyGPSEmulate::processIncomingPacket() {
  ...
  if(receivedPacket.validPacket) {
    ...
    // Poll CFG-NAVX5 (navigation engine expert settings)
      ...
      responsePacket.payload[30] = emulatorSettings.aopOrbMaxErr;
...
ubxPVTInfo_t TeenyGPSEmulate::getPVTPacketInfo() {
  ...
  ubxPVTInfo.numSV = ubxPVTPacket.payload[23];
  int32_t longitude;
  longitude = ubxPVTPacket.payload[24];
  longitude |= ubxPVTPacket.payload[25] << 8;
  longitude |= ubxPVTPacket.payload[26] << 16;
  longitude |= ubxPVTPacket.payload[27] << 24;
  ubxPVTInfo.longitude = (float)longitude * 1e-7;
  int32_t latitude;
  latitude = ubxPVTPacket.payload[28];
  latitude |= ubxPVTPacket.payload[29] << 8;
  latitude |= ubxPVTPacket.payload[30] << 16;
  latitude |= ubxPVTPacket.payload[31] << 24;
  ubxPVTInfo.latitude = (float)latitude * 1e-7;
  ubxPVTInfo.altitudeMSL = ubxPVTPacket.payload[36];
  ubxPVTInfo.altitudeMSL |= ubxPVTPacket.payload[37] << 8;
  ubxPVTInfo.altitudeMSL |= ubxPVTPacket.payload[38] << 16;
  ubxPVTInfo.altitudeMSL |= ubxPVTPacket.payload[39] << 24;
  ubxPVTInfo.altitudeMSL = ubxPVTInfo.altitudeMSL / 1000;
  ubxPVTInfo.hAcc = ubxPVTPacket.payload[40];
  ubxPVTInfo.hAcc |= ubxPVTPacket.payload[41] << 8;
  ubxPVTInfo.hAcc |= ubxPVTPacket.payload[42] << 16;
  ubxPVTInfo.hAcc |= ubxPVTPacket.payload[43] << 24;
  ubxPVTInfo.hAcc = ubxPVTInfo.hAcc / 1000;
  ubxPVTInfo.vAcc = ubxPVTPacket.payload[44];
  ubxPVTInfo.vAcc |= ubxPVTPacket.payload[45] << 8;
  ubxPVTInfo.vAcc |= ubxPVTPacket.payload[46] << 16;
  ubxPVTInfo.vAcc |= ubxPVTPacket.payload[47] << 24;
  ubxPVTInfo.vAcc = ubxPVTInfo.vAcc / 1000;
  int32_t headMot;
  headMot = ubxPVTPacket.payload[64];
  headMot |= ubxPVTPacket.payload[65] << 8;
  headMot |= ubxPVTPacket.payload[66] << 16;
  headMot |= ubxPVTPacket.payload[67] << 24;
  ubxPVTInfo.headMot = (float)headMot * 1e-5;
  uint16_t pDOP;
  pDOP = ubxPVTPacket.payload[76];
  pDOP |= ubxPVTPacket.payload[77] << 8;
  ubxPVTInfo.pDOP = (float)pDOP * 1e-2;
  return ubxPVTInfo;
}
